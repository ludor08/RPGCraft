...
import org.rpg.rPGCraft.Traits.Active.AuraOfWeakness;
...
import org.rpg.rPGCraft.Traits.Passive.RebukeOfTheFlame;
...
public class Sage extends PlayableClass
{
    ...
    public Sage(Main main)
    {
        super("Sage", ChatColor.LIGHT_PURPLE, Material.STICK, List.of(ChatColor.AQUA + "Uses spells and brews potions to heal, buff, and debuff."), new TraitTree(List.of(
                new Node(new Vector2d(2,2), List.of(new GreaterCapacity_1(main)), "000"),
                new Node(new Vector2d(1,1), List.of(new BoostedHealing_speed(main)), "000"),
                new Node(new Vector2d(1,2), List.of(new RebukeOfTheFlame(main)), "000"),
                ...
                new Node(new Vector2d(5,2), List.of(new EmpoweredMixture_1(main)), "000"),
                new Node(new Vector2d(3,2), List.of(new AuraOfWeakness(main)), "000")
        )));
    }
}
