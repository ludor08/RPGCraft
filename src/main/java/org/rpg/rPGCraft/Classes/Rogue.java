...
public class Rogue extends PlayableClass
{
    ...
    public Rogue()
    {
        super("Rogue", ChatColor.DARK_RED, Material.IRON_SWORD, List.of(ChatColor.AQUA + "Uses close and long range weapons, is ly focused on combos."), new TraitTree(List.of(
