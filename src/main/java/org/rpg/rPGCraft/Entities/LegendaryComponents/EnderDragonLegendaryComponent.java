...
public class EnderDragonLegendaryComponent extends LegendaryComponent
{
    public EnderDragonLegendaryComponent()
    {
        super(
                0.05f,
    ...
    public void ShowTickOfLegendary(int tick, Entity entity)
    {
        for (int i = 0; i < 3; i++)
        {
            ...
            entity.getWorld().spawnParticle(Particle.DRAGON_BREATH, location, 10, 0,0,0,0);
        }
    }
    ...
    {
        return ChatColor.DARK_PURPLE + ChatColor.BOLD.toString() + "LEGENDARY " + name;
    }
}
