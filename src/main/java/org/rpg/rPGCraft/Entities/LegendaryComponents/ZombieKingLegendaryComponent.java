...
public class ZombieKingLegendaryComponent extends LegendaryComponent
{
    public ZombieKingLegendaryComponent()
    {
        super(
                0.05f,
    ...
    public void ShowTickOfLegendary(int tick, Entity entity)
    {
        for (int i = 0; i < 3; i++)
        {
            ...
            entity.getWorld().spawnParticle(Particle.ITEM_SLIME, location, 10, 0,0,0,0);
        }
    }
    ...
    {
        return ChatColor.GREEN + ChatColor.BOLD.toString() + "LEGENDARY " + name;
    }
}
